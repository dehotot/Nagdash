...
if (isset($filter_hide_ksps) && $filter_hide_ksps == 1) {
    ...
    if (count($known_services) > 0) {
        ...
        echo '<tr class="tableheader"><th width="25%">Hostname</th><th width="20%">Service</th><th width="15%">Comment</th><th width="18%">State</th><th width="10%">Duration</th><th width="5%">Attempt</th>';
